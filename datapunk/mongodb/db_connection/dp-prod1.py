...
def get_mongo_client(db_key='mongo_prod1'):
...
def get_all_documents(collection_name, db_key='mongo_prod1'):
...
def insert_document(collection_name, document, db_key='mongo_prod1'):
