...
def get_mongo_client(db_key='mongo_test2'):
...
def get_all_documents(collection_name, db_key='mongo_test2'):
...
def insert_document(collection_name, document, db_key='mongo_test2'):
